...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'a_oauth_tokens', 'a_oauth_states', 'a_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'a_users', $this, $this->get('dispatcher'), './../', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'a_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'a_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './../', 'php', 'a_forums', 'a_posts', 'a_topics', 'a_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('a_captcha_questions', 'a_captcha_answers', 'a_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'a_ext', './../', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './../', 'adm/', 'php', 'a_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'a_migrations', './../', 'php', 'a_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './../', 'php', 'a_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'a_modules', './../', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'a_notification_types', 'a_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'a_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'a_notification_types', 'a_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'a_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'a_profile_fields', 'a_profile_lang', 'a_profile_fields_data');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000127847c000000002d3c3f53(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'a_bbcodes', 'a_smilies', 'a_styles', 'a_words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'a_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'a_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'a_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'a_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'a_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'a_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'a_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './../', 'php', 'a_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'a_acl_groups',
            'tables.acl_options' => 'a_acl_options',
            'tables.acl_roles' => 'a_acl_roles',
            'tables.acl_roles_data' => 'a_acl_roles_data',
            'tables.acl_users' => 'a_acl_users',
            'tables.attachments' => 'a_attachments',
            'tables.auth_provider_oauth_token_storage' => 'a_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'a_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'a_oauth_accounts',
            'tables.banlist' => 'a_banlist',
            'tables.bbcodes' => 'a_bbcodes',
            'tables.bookmarks' => 'a_bookmarks',
            'tables.bots' => 'a_bots',
            'tables.captcha_qa_questions' => 'a_captcha_questions',
            'tables.captcha_qa_answers' => 'a_captcha_answers',
            'tables.captcha_qa_confirm' => 'a_qa_confirm',
            'tables.config' => 'a_config',
            'tables.config_text' => 'a_config_text',
            'tables.confirm' => 'a_confirm',
            'tables.disallow' => 'a_disallow',
            'tables.drafts' => 'a_drafts',
            'tables.ext' => 'a_ext',
            'tables.extensions' => 'a_extensions',
            'tables.extension_groups' => 'a_extension_groups',
            'tables.forums' => 'a_forums',
            'tables.forums_access' => 'a_forums_access',
            'tables.forums_track' => 'a_forums_track',
            'tables.forums_watch' => 'a_forums_watch',
            'tables.groups' => 'a_groups',
            'tables.icons' => 'a_icons',
            'tables.lang' => 'a_lang',
            'tables.log' => 'a_log',
            'tables.login_attempts' => 'a_login_attempts',
            'tables.migrations' => 'a_migrations',
            'tables.moderator_cache' => 'a_moderator_cache',
            'tables.modules' => 'a_modules',
            'tables.notification_types' => 'a_notification_types',
            'tables.notifications' => 'a_notifications',
            'tables.poll_options' => 'a_poll_options',
            'tables.poll_votes' => 'a_poll_votes',
            'tables.posts' => 'a_posts',
            'tables.privmsgs' => 'a_privmsgs',
            'tables.privmsgs_folder' => 'a_privmsgs_folder',
            'tables.privmsgs_rules' => 'a_privmsgs_rules',
            'tables.privmsgs_to' => 'a_privmsgs_to',
            'tables.profile_fields' => 'a_profile_fields',
            'tables.profile_fields_data' => 'a_profile_fields_data',
            'tables.profile_fields_options_language' => 'a_profile_fields_lang',
            'tables.profile_fields_language' => 'a_profile_lang',
            'tables.ranks' => 'a_ranks',
            'tables.reports' => 'a_reports',
            'tables.reports_reasons' => 'a_reports_reasons',
            'tables.search_results' => 'a_search_results',
            'tables.search_wordlist' => 'a_search_wordlist',
            'tables.search_wordmatch' => 'a_search_wordmatch',
            'tables.sessions' => 'a_sessions',
            'tables.sessions_keys' => 'a_sessions_keys',
            'tables.sitelist' => 'a_sitelist',
            'tables.smilies' => 'a_smilies',
            'tables.sphinx' => 'a_sphinx',
            'tables.styles' => 'a_styles',
            'tables.styles_template' => 'a_styles_template',
            'tables.styles_template_data' => 'a_styles_template_data',
            'tables.styles_theme' => 'a_styles_theme',
            'tables.styles_imageset' => 'a_styles_imageset',
            'tables.styles_imageset_data' => 'a_styles_imageset_data',
            'tables.teampage' => 'a_teampage',
            'tables.topics' => 'a_topics',
            'tables.topics_posted' => 'a_topics_posted',
            'tables.topics_track' => 'a_topics_track',
            'tables.topics_watch' => 'a_topics_watch',
            'tables.user_group' => 'a_user_group',
            'tables.user_notifications' => 'a_user_notifications',
            'tables.users' => 'a_users',
            'tables.warnings' => 'a_warnings',
            'tables.words' => 'a_words',
            'tables.zebra' => 'a_zebra',
...
class phpbbtemplatetwiglexer_000000000127847c000000002d3c3f53 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59a831648b1f6543750280 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59a831648b1ff631551319 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59a831648b1d3588365377 = array(
    ...
    {
        $this->initializer59a831648b1ff631551319 && $this->initializer59a831648b1ff631551319->__invoke($this->valueHolder59a831648b1f6543750280, $this, 'set_environment', array('env' => $env), $this->initializer59a831648b1ff631551319);

        return $this->valueHolder59a831648b1f6543750280->set_environment($env);
    }
    ...
    {
        $this->initializer59a831648b1ff631551319 && $this->initializer59a831648b1ff631551319->__invoke($this->valueHolder59a831648b1f6543750280, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59a831648b1ff631551319);

        return $this->valueHolder59a831648b1f6543750280->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59a831648b1ff631551319 && $this->initializer59a831648b1ff631551319->__invoke($this->valueHolder59a831648b1f6543750280, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59a831648b1ff631551319);

        return $this->valueHolder59a831648b1f6543750280->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59a831648b1ff631551319 = $initializer;
    }
    ...
    {
        $this->initializer59a831648b1ff631551319 && $this->initializer59a831648b1ff631551319->__invoke($this->valueHolder59a831648b1f6543750280, $this, '__get', array('name' => $name), $this->initializer59a831648b1ff631551319);

        if (isset(self::$publicProperties59a831648b1d3588365377[$name])) {
            return $this->valueHolder59a831648b1f6543750280->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59a831648b1f6543750280;
    ...
    {
        $this->initializer59a831648b1ff631551319 && $this->initializer59a831648b1ff631551319->__invoke($this->valueHolder59a831648b1f6543750280, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59a831648b1ff631551319);
    ...
    {
        $this->initializer59a831648b1ff631551319 && $this->initializer59a831648b1ff631551319->__invoke($this->valueHolder59a831648b1f6543750280, $this, '__isset', array('name' => $name), $this->initializer59a831648b1ff631551319);
    ...
    {
        $this->initializer59a831648b1ff631551319 && $this->initializer59a831648b1ff631551319->__invoke($this->valueHolder59a831648b1f6543750280, $this, '__unset', array('name' => $name), $this->initializer59a831648b1ff631551319);
    ...
    {
        $this->initializer59a831648b1ff631551319 && $this->initializer59a831648b1ff631551319->__invoke($this->valueHolder59a831648b1f6543750280, $this, '__clone', array(), $this->initializer59a831648b1ff631551319);

        $this->valueHolder59a831648b1f6543750280 = clone $this->valueHolder59a831648b1f6543750280;
    }

    public function __sleep()
    {
        $this->initializer59a831648b1ff631551319 && $this->initializer59a831648b1ff631551319->__invoke($this->valueHolder59a831648b1f6543750280, $this, '__sleep', array(), $this->initializer59a831648b1ff631551319);

        return array('valueHolder59a831648b1f6543750280');
    }
    ...
    {
        return $this->initializer59a831648b1ff631551319;
    }
    ...
    {
        return $this->initializer59a831648b1ff631551319 && $this->initializer59a831648b1ff631551319->__invoke($this->valueHolder59a831648b1f6543750280, $this, 'initializeProxy', array(), $this->initializer59a831648b1ff631551319);
    }
    ...
    {
        return null !== $this->valueHolder59a831648b1f6543750280;
    }
    ...
    {
        return $this->valueHolder59a831648b1f6543750280;
    }
