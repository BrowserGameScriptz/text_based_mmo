...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000007c29c86a00000000447adb25(
...
class phpbbtemplatetwiglexer_000000007c29c86a00000000447adb25 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder59a831678f48e538145825 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer59a831678f498321173134 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties59a831678f46c742864859 = array(
    ...
    {
        $this->initializer59a831678f498321173134 && $this->initializer59a831678f498321173134->__invoke($this->valueHolder59a831678f48e538145825, $this, 'set_environment', array('env' => $env), $this->initializer59a831678f498321173134);

        return $this->valueHolder59a831678f48e538145825->set_environment($env);
    }
    ...
    {
        $this->initializer59a831678f498321173134 && $this->initializer59a831678f498321173134->__invoke($this->valueHolder59a831678f48e538145825, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer59a831678f498321173134);

        return $this->valueHolder59a831678f48e538145825->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer59a831678f498321173134 && $this->initializer59a831678f498321173134->__invoke($this->valueHolder59a831678f48e538145825, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer59a831678f498321173134);

        return $this->valueHolder59a831678f48e538145825->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer59a831678f498321173134 = $initializer;
    }
    ...
    {
        $this->initializer59a831678f498321173134 && $this->initializer59a831678f498321173134->__invoke($this->valueHolder59a831678f48e538145825, $this, '__get', array('name' => $name), $this->initializer59a831678f498321173134);

        if (isset(self::$publicProperties59a831678f46c742864859[$name])) {
            return $this->valueHolder59a831678f48e538145825->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder59a831678f48e538145825;
    ...
    {
        $this->initializer59a831678f498321173134 && $this->initializer59a831678f498321173134->__invoke($this->valueHolder59a831678f48e538145825, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer59a831678f498321173134);
    ...
    {
        $this->initializer59a831678f498321173134 && $this->initializer59a831678f498321173134->__invoke($this->valueHolder59a831678f48e538145825, $this, '__isset', array('name' => $name), $this->initializer59a831678f498321173134);
    ...
    {
        $this->initializer59a831678f498321173134 && $this->initializer59a831678f498321173134->__invoke($this->valueHolder59a831678f48e538145825, $this, '__unset', array('name' => $name), $this->initializer59a831678f498321173134);
    ...
    {
        $this->initializer59a831678f498321173134 && $this->initializer59a831678f498321173134->__invoke($this->valueHolder59a831678f48e538145825, $this, '__clone', array(), $this->initializer59a831678f498321173134);

        $this->valueHolder59a831678f48e538145825 = clone $this->valueHolder59a831678f48e538145825;
    }

    public function __sleep()
    {
        $this->initializer59a831678f498321173134 && $this->initializer59a831678f498321173134->__invoke($this->valueHolder59a831678f48e538145825, $this, '__sleep', array(), $this->initializer59a831678f498321173134);

        return array('valueHolder59a831678f48e538145825');
    }
    ...
    {
        return $this->initializer59a831678f498321173134;
    }
    ...
    {
        return $this->initializer59a831678f498321173134 && $this->initializer59a831678f498321173134->__invoke($this->valueHolder59a831678f48e538145825, $this, 'initializeProxy', array(), $this->initializer59a831678f498321173134);
    }
    ...
    {
        return null !== $this->valueHolder59a831678f48e538145825;
    }
    ...
    {
        return $this->valueHolder59a831678f48e538145825;
    }
